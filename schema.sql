-- Generated by Supabase at 2023-09-29T14:49:10.938Z
...
CREATE FUNCTION public.fn_create_category(p_name text, p_parent_id bigint) RETURNS bigint
    LANGUAGE plpgsql
    AS $$
declare 
...
ALTER TABLE public.spec_fields ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.spec_fields_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE public.variation_specs (
...
ALTER TABLE ONLY public.product_specs
    ADD CONSTRAINT product_specs_pkey PRIMARY KEY (product_id, spec_id);
...
ALTER TABLE ONLY public.spec_fields
    ADD CONSTRAINT spec_fields_pkey PRIMARY KEY (id);

ALTER TABLE ONLY public.variation_specs
    ADD CONSTRAINT variation_specs_pkey PRIMARY KEY (variation_id, spec_id);
...
ALTER TABLE ONLY public.product_specs
    ADD CONSTRAINT product_specs_product_id_fkey FOREIGN KEY (product_id) REFERENCES public.products(id) ON UPDATE CASCADE ON DELETE CASCADE;

ALTER TABLE ONLY public.product_specs
    ADD CONSTRAINT product_specs_spec_id_fkey FOREIGN KEY (spec_id) REFERENCES public.spec_fields(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE ONLY public.spec_fields
    ADD CONSTRAINT spec_fields_category_id_fkey FOREIGN KEY (category_id) REFERENCES public.categories(id) ON UPDATE CASCADE ON DELETE CASCADE;

ALTER TABLE ONLY public.variation_specs
    ADD CONSTRAINT variation_specs_spec_id_fkey FOREIGN KEY (spec_id) REFERENCES public.spec_fields(id) ON UPDATE CASCADE ON DELETE CASCADE;

ALTER TABLE ONLY public.variation_specs
    ADD CONSTRAINT variation_specs_variation_id_fkey FOREIGN KEY (variation_id) REFERENCES public.product_variants(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE public.variation_specs ENABLE ROW LEVEL SECURITY;
...
GRANT ALL ON FUNCTION public.fn_create_category(p_name text, p_parent_id bigint) TO anon;
GRANT ALL ON FUNCTION public.fn_create_category(p_name text, p_parent_id bigint) TO authenticated;
GRANT ALL ON FUNCTION public.fn_create_category(p_name text, p_parent_id bigint) TO service_role;
...
GRANT ALL ON TABLE public.spec_fields TO anon;
GRANT ALL ON TABLE public.spec_fields TO authenticated;
GRANT ALL ON TABLE public.spec_fields TO service_role;

GRANT ALL ON SEQUENCE public.spec_fields_id_seq TO anon;
GRANT ALL ON SEQUENCE public.spec_fields_id_seq TO authenticated;
GRANT ALL ON SEQUENCE public.spec_fields_id_seq TO service_role;

GRANT ALL ON TABLE public.variation_specs TO anon;
GRANT ALL ON TABLE public.variation_specs TO authenticated;
GRANT ALL ON TABLE public.variation_specs TO service_role;
